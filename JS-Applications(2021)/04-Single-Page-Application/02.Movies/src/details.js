...
function createDetails(movie, likes, hasLiked){
    ...
    if(userData != null) {
        if(userData.id == movie._ownerId) {
            controls.appendChild(e('button', {className: 'btn btn-danger', href: "#"}, "Delete"));
            controls.appendChild(e('button', {className: 'btn btn-warning', href: "#"}, "Edit"));
        } else {
            if(hasLiked.length > 0) {
                controls.appendChild(e('button', {className: 'btn btn-primary', href: "#", onClick: onUnlike}, "Unlike"));
            } else {
                controls.appendChild(e('button', {className: 'btn btn-primary', href: "#", onClick: onLike}, "Like"));
            }
